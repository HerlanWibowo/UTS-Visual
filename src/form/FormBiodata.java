...
public class FormBiodata extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cmbProdi.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Program Studi", "Teknik Informatika", "Teknik Mesin", "Teknik Industri" }));
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        try {
            ...
            if (rs.next()) {
                ...
                String sql = "INSERT INTO tbl_biodata (nama, nim, ttl, jekel, prodi, alamat) VALUES ('"
                        + tfNama.getText() + "', '"
                        + tfNim.getText() + "', '"
                        + tfTTL.getText() + "', '"
                        + jekel + "', '"
    ...
    try {
        ...
        // Memeriksa apakah NIM ada di database
